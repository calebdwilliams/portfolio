...
export const resumeExperience: Experience[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Lead front-end developer on Capital One's design system. In this role I work with cross-functional teams across the enterprise to deliver accessible, performant, pixel-perfect code to millions of customers.",
    description: [
