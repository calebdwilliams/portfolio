...
export const workProjects: Project[] = [
  {
    title: "Slack",
    body: "Slack is an industry-leading communication tool. As staff front-end engineer, I am responsible for the continued growth and maintenance of the core application capabilities including messages, threads, channels and much more.",
